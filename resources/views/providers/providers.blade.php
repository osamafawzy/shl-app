...
@section('content')
    <div id="providers">
        <div class="row" style="cursor: pointer">
            <data-tables :data="providersData" :show-action-bar="false" :custom-filters="customFilters"
                ...
                @can('providers.update',\Illuminate\Support\Facades\Auth::user())
...
@endcan
                ...
                @can('providers.view',\Illuminate\Support\Facades\Auth::user())
...
@section('page-script-level')
    <script src="{{asset('AppAdmin/providers.js')}}"></script>
@endsection