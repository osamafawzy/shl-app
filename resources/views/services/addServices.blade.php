            ...
            <div class="panel-body">
                <form :model="ServicesForm">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="file"  @change="ConvertServicesIamge()" class="form-control" id="services_icone" />
                        </div>
                        <div class="col-md-2">
                            <img src="" class="img-responsive" id="services_icone" width="100px" height="100px">
                        </div>
                    </div>
                    <div class="sp-10"></div>
                    <div class="row" v-for="(sub_services,index) in ServicesForm.sub_services">
                        ...
                        <div class="col-md-1">
                            <img width="100px" width="100px" src="" :id=index+'img' class="img-responsive">
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <el-radio v-model="ServicesForm.services_type" label="1">موقع واحد
                            </el-radio>
                            &nbsp;&nbsp;&nbsp;

                        </div>
                        <div class="col-md-4">
                            <el-radio v-model="ServicesForm.services_type" label="2">موقعين
                            </el-radio>
                            &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 " v-show="ServicesForm.services_type === '2'">
                            <el-radio v-model="ServicesForm.serivces_payment_type_id" label="1">كاش
                            </el-radio>


                            <el-radio v-model="ServicesForm.serivces_payment_type_id" label="2"> اخرى
                            </el-radio>
                        </div>
                    ...
                    <div class="sp-10"></div>
                    <div class="row">
                        <div class="col-md-2" v-show="ServicesForm.services_type === '1'"><label for="">مدة انتقال العرض
                        ...
                        <div class="col-md-push-6">
                            ...
                            <div class="col-md-1" v-show="ServicesForm.services_type === '2'"><label for=""> مدة فاعليه
                                    العروض </label></div>
                            <div class="col-md-2" v-show="ServicesForm.services_type === '2'">
...
@section('page-script-level')
    <script src="{{asset('AppAdmin/addservices.js')}}"></script>
@endsection